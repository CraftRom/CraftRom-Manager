...
interface DownloadClient {
    interface DownloadCallback {
        fun onResponse(statusCode: Int, url: String?, headers: Headers?)
        fun onSuccess(destination: File?)
        fun onFailure(cancelled: Boolean)
    }

    interface ProgressListener {
        fun update(bytesRead: Long, contentLength: Long, speed: Long, eta: Long, done: Boolean)
    }
    ...
    class Builder {
        ...
        fun build(): DownloadClient {
            ...
            checkNotNull(mCallback) { "No download callback defined" }
